...
wrSVfix <- function() {
  glue::glue('### Useful stuff \n',
             ...
             '}} \n',
             ' \n',
             'FindMarkers <- function(inpmeta,group_by = NULL,group.1 = NULL, group.2 = NULL,inpH5,inpGene,use_top_gene=100){{ \n',
             ...
             '}} \n',
             ' \n',
             'FindAllMarkers <- function(inpmeta,group_by,inpH5,inpGene,use_top_gene=100){{ \n',
...
wrSVmain <- function(prefix, subst = "") {
  glue::glue('optCrt="{{ option_create: function(data,escape) {{return(\'<div class=\\"create\\"><strong>\' + \'</strong></div>\');}} }}" \n', 
             ...
             '        use_data$Diff_table <- FindMarkers({prefix}meta,group_by = input${prefix}e1grp,group.1=input${prefix}e1grp1,group.2=input${prefix}e1grp2,inpH5="{prefix}gexpr.h5",inpGene={prefix}gene,use_top_gene = as.numeric(input$top_gene))   \n',
             '      }})  \n',
             '    }})  \n',
             '    findallmarkers <- shiny::reactive({{  \n',
             '      shiny::withProgress(message="processing",value=0.3,{{  \n',
             '        use_data$Diff_table <- FindAllMarkers({prefix}meta,group_by = input${prefix}e1grp,inpH5="{prefix}gexpr.h5",inpGene={prefix}gene,use_top_gene = as.numeric(input$top_gene))  \n',
             '      }})  \n',
             '    }})  \n',
